...
export async function GET(request: Request) {
  ...
  try {
    ...
    let query = adminDb
      .collection("adStats")
      .where("uid", "==", uid)
      .where("networkId", "==", "exoclick") as FirebaseFirestore.Query;
    ...
    // Aggregate by country — skip records without country data
    ...
    const totalCost = allCountries.reduce((s, r) => s + r.cost, 0);
    ...
    console.error("GET /api/networks/exoclick/stats/by-country error:", error);
